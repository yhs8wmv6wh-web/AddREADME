...
const base = process.env.GITHUB_PAGES ? '/AddREADME/fremdwoerter/' : '/'
...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Fremdwörter',
        short_name: 'Fremdwörter',
        description: 'Fremdwörter eintragen, von KI kurz erklären lassen (mit Etymologie) und alphabetisch nachschlagen.',
        theme_color: '#1f2028',
