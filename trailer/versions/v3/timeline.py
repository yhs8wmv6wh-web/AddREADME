...
SHOTS = [
    ...
    dict(id="S16", act="Eskalation", start=51.75, dur=2.25, img="cat",
         kb=(1.00, 1.10, 0.5, 0.5, 0.5, 0.45), mood="Stop-Time-Break unter dem Wort, ab 52,5 Snare-Anstieg"),
    ...
    dict(id="S20", act="Pointe", start=63.0, dur=6.75, img="interview",
         kb=(1.00, 1.80, 0.5, 0.5, 0.95, 0.30), fade_in=0.5, mood="Leises Klavier, bricht vor der Antwort ab"),
...
VO = [
    ...
    dict(id="V07", t=31.3, who="ERZÄHLER", text="Also lernte er [p:300] was Anständiges."),
    dict(id="V08", t=35.3, who="ERZÄHLER", text="Klavier."),
