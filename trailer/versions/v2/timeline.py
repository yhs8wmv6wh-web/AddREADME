...
SHOTS = [
    # --- EINSTIEG ---
    dict(id="S01", act="Einstieg", start=0.0, dur=6.75, img="ruhr_dusk",
         kb=(1.00, 1.12, 0.5, 0.6, 0.5, 0.55), fade_in=1.5,
         lower="MÜLHEIM AN DER RUHR · 1955", mood="Solo-Klavier, Moll, leise"),
    dict(id="S02", act="Einstieg", start=6.75, dur=3.75, img="window_night",
    ...
    dict(id="S09b", act="Eskalation", start=37.5, dur=1.5, card="piano", mood="Ostinato + Klavier-Lauf"),
    ...
    dict(id="S15b", act="Eskalation", start=49.5, dur=2.25, img="piano_keys",
         kb=(1.00, 1.20, 0.3, 0.5, 0.6, 0.5), mood="Streicher steigen chromatisch"),
    dict(id="S16", act="Eskalation", start=51.75, dur=2.25, img="cat",
         kb=(1.00, 1.10, 0.5, 0.5, 0.5, 0.45), mood="Höhepunkt der Steigerung"),
    ...
    dict(id="S20", act="Pointe", start=63.0, dur=6.75, img="interview",
         kb=(1.00, 1.35, 0.5, 0.5, 0.72, 0.42), fade_in=0.5, mood="Leises Klavier, bricht vor der Antwort ab"),
...
VO = [
    dict(id="V01", t=0.75, who="ERZÄHLER", text="Mülheim an der Ruhr. [p:300] Neunzehnhundertfünfundfünfzig."),
    dict(id="V02", t=6.9,  who="ERZÄHLER", text="Ein Junge wollte [p:200] nur eine Sache."),
    ...
    dict(id="V07", t=31.7, who="ERZÄHLER", text="Also lernte er [p:300] was Anständiges."),
    dict(id="V08", t=37.5, who="ERZÄHLER", text="Klavier."),
